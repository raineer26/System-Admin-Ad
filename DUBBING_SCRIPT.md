...
#### Complete Spoken Script:
> **Segment 1 — Documentary Summation (00:00 - 00:14):**
...
| Beat & Timecode | Spoken Narration Segment | Visual Layout & Staging | On-Screen Text (OST) / Kinetic Type | Motion & Camera Action | Sound Design / SFX Cue |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Beat 13.1**<br>`00:00 - 00:07`<br>(0–210f) | *"Jansen may describe himself as a webmaster and graphic designer. But behind that role is someone keeping an organization connected and operational."* | Opening tribute card honoring Jansen Lee. Clean glowing typography and subtle ambient telemetry against the obsidian perspective floor. | `[DOCUMENTARY TRIBUTE]`<br>`[H1] BEHIND THE SYSTEM`<br>`[HONOR ROLL] JANSEN LEE // WEBMASTER & DESIGNER` | Camera smooth dolly push-in (`scale: 1.0 -> 1.06`). Badge spring-reveal with soft radial bloom. | **[SFX]** Gentle, emotive piano swell, subtle server hum. |
| **Beat 13.2**<br>`00:07 - 00:14`<br>(210–420f) | *"The work is often invisible. But the impact isn't. Because when technology works, people can focus on what they actually need to do."* | Big kinetic contrast typography: `THE WORK IS INVISIBLE` crossfading into blinding cyan `THE IMPACT ISN'T`. Stage primes for smooth transition. | `[CONTRAST]`<br>`[H1] THE WORK IS INVISIBLE.`<br>`[H1 GLOW] THE IMPACT ISN'T.` | Words punch with soft scale impulse (`scale: 1.04`). Light-wash beam transitions Act 1 out upward to reveal spacious group stage. | **[SFX]** Resonant cello sustain, delicate glass sparkle, whoosh wash transition. |
| **Beat 13.3**<br>`00:14 - 00:26`<br>(420–780f) | **[CAST INTRODUCTIONS — NEW AUDIO REQUIRED]**<br><br>🔵 **Deign Grey O. Lazaro** (`00:14.5 - 00:16.8`):<br>*“I’m Deign Lazaro — on narration and audio generation.”*<br><br>🟣 **Raineer C. Rosado** (`00:16.8 - 00:19.1`):<br>*“I’m Raineer Rosado — on creative direction and motion design.”*<br><br>🔴 **Lorraine Isabel B. Cabigon** (`00:19.1 - 00:21.4`):<br>*“I’m Lorraine Cabigon — on direction and visual design.”*<br><br>🟢 **Faijah F. Nonoy** (`00:21.4 - 00:23.7`):<br>*“I’m Faijah Nonoy — on scriptwriting and our subject interview.”*<br><br>🟡 **Sean Mark P. Vasquez** (`00:23.7 - 00:26.0`):<br>*“I’m Sean Vasquez — documentary narrator.”* | **Spacious 5-Member Outro Stage**: Stage clears of clutter. 5 distinct, wide glassmorphism member cards enter with 3D perspective flips. As each member speaks their line, their card illuminates with signature spotlight glow (Cyan, Purple, Rose, Emerald, Amber), a speech bubble tag, and pulsating audio waveform bars. | `[PRODUCED BY]`<br>`BSIT 4-5 // PRODUCTION TEAM`<br>`1. DEIGN LAZARO • 2. RAINEER ROSADO`<br>`3. LORRAINE CABIGON • 4. FAIJAH NONOY • 5. SEAN VASQUEZ` | Staggered 3D tilt-in (`stagger: 0.18s`, `rotateY: -15 -> 0`). Virtual cursor sweeps to highlight speaking member in real-time. | **[SFX]** 5 distinct harmonic synthesizer chimes synchronized to each member card activation. |
| **Beat 13.4**<br>`00:26 - 00:30`<br>(780–900f) | **[ENSEMBLE OUTRO — NEW AUDIO REQUIRED]**<br><br>👥 **BSIT 4-5 Ensemble / Deign** (`00:26.0 - 00:30.0`):<br>*“This has been Behind the System — our documentary project for System Administration.”* | Grand final resolution: The BSIT 4-5 official academic badge illuminates, followed by the steady emerald pulse of `ALL SYSTEMS OPERATIONAL // 100% ONLINE`. Solitary radar rings expand into infinite black. | `[ACADEMIC CREDITS]`<br>`BSIT 4-5 • AY 2025–2026`<br>`[FINAL STATUS] ● ALL SYSTEMS OPERATIONAL // 100% ONLINE` | Camera pulls back smoothly (`scale: 1.0 -> 1.02`), holding hero frame to perfection before graceful fade to black. | **[SFX]** Resolving grand acoustic piano chord, steady rhythmic heartbeat beep, soft fade to quiet silence. |
